...
model_file = os.path.join(script_dir, 'mobilenet_v2_1.0_224_inat_bird_quant.tflite')
...
image = Image.open("../Pajaros/img_pajaros/ScarletMacaw.jpg").convert('RGB').resize(size, Image.ANTIALIAS)
